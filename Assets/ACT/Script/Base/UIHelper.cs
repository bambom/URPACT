...
{
    public static float WordToScreenModify { get { return WindowsRoot.ManualHeight / Screen.height; }  }
	public static float UIModify { get { return 1 + (float)Screen.width / Screen.height - 1200 / 800f; } }//UI LocalPos the modify
	
	public static Vector2 ScreenPointToUIPoint(Vector2 screenPoint)
	{
		return (screenPoint - new Vector2( (float)Screen.width / 2, (float)Screen.height / 2)) * WordToScreenModify;
	}
	...
	{
		return UIPoint / WordToScreenModify + new Vector2( (float)Screen.width / 2, (float)Screen.height / 2);
	}
	...
	public static UIGuideEvent GuideRegister(GameObject obj)
    {
        return UIGuideEvent.Get(obj);
    }
	
    public static UIGuideEvent GuideRegister(Transform transform, string name)
    {
        return GuideRegister(transform.Find(name).gameObject);
    }
